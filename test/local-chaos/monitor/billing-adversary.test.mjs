...
const runnerPath = fileURLToPath(new URL("./billing-adversary.mjs", import.meta.url));
...
before(async () => {
  ...
  await Promise.all([
    execFileAsync("go", ["build", "-o", binary, "./cmd/caserver"], {
      cwd: repositoryRoot,
      timeout: 120000,
      maxBuffer: 4 * 1024 * 1024,
    }),
    execFileAsync("go", ["build", "-o", componentProbeBinary, "./cmd/billing-adversary-probe"], {
      cwd: repositoryRoot,
      timeout: 120000,
      maxBuffer: 4 * 1024 * 1024,
    }),
